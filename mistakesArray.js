const MistakesArray = [
  {
    date: "1-May-2018",
    title: "Writing Code Without Planning",
    text:
      "Programming is mostly about reading previous code, researching what is needed and how it fits within the current system, and planning the writing of features with small, testable increments. The actual writing of lines of code is probably only 10% of the whole process.Do not think about programming as writing lines of code. Programming is a logic-based creativity that needs nurturing."
  },
  {
    date: "2-May-2018",
    title: "Planning Too Much Before Writing Code",
    text:
  ...
  {
    date: "3-May-2018",
    title: "Underestimating the Importance of Code Quality",
    text:
